"""Training the images to create a model that predicts if user is on cellphone"""
...
def display_data(array_mat):
    ...
    """reshaping the array back into 40x80 pixels for display"""
...
model_path = "C:\\Users\\Dell\\Desktop\\Projects\\majorproj\\faceMatching\\model_trained\\modeluserobj5\\modeluser-obj-5"
...
img_file = 'C:/Users/Dell/Desktop/Projects/majorproj/faceMatching/faceobjneg/face (9).png'
...
for i in range(1,1727):
    img_file = 'C:/Users/Dell/Desktop/Projects/majorproj/faceMatching/faceobjneg/face (' + str(i) + ').png'
...
for i in range(1,1531):
    img_file = 'C:/Users/Dell/Desktop/Projects/majorproj/faceMatching/faceobjpos/face (' + str(i) + ').png'
